...
public class GradeProgram {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (gradeText.equals("vyborny"))
                System.out.println("1");
            else if (gradeText.equals("chvalitebny"))
                System.out.println("2");
            else if (gradeText.equals("dobry"))
                System.out.println("3");
            else if (gradeText.equals("dostatočny"))
                System.out.println("4");
            else if (gradeText.equals("nedostatočny"))
                System.out.println("5");
            else if (gradeText.equals("koniec"))
